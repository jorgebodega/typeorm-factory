...
- Shared tooling files must stay byte-identical with `typeorm-seeding`: `.commitlintrc`, `.github/workflows/*`, `.github/renovate.json`, `.releaserc.json`, `biome.json`, `jest.config.js`, `pnpm-workspace.yaml`, `tsconfig.json`.
